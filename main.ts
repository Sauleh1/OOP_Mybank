...
class BankDetails {
    ...
    public BankBalance: number = randomInteger(10000, 2000000)
    constructor (
        BankID: number,
        BankPIN: number
    ) {
